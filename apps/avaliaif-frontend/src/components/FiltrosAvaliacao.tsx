    ...
    <Card elevation={2} sx={{ borderRadius: 3 }}>
      <CardContent>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
          ...
          <FormControl fullWidth size="small" sx={{ flex: 1, minWidth: '180px' }}>
            <InputLabel>Status</InputLabel>
            <Select name="status" value={filtros.status} label="Status" onChange={handleChange}>
              <MenuItem value=""><em>Todos os Status</em></MenuItem>
              <MenuItem value="Revisão Coordenação">Revisão Coordenação</MenuItem>
              ...
              <MenuItem value="Minutas Finalizadas">Minutas Finalizadas</MenuItem>
              <MenuItem value="Minutas Não Enviadas">Minutas Não Enviadas</MenuItem>
            </Select>
          </FormControl>

          <FormControl fullWidth size="small" sx={{ flex: 1, minWidth: '180px' }}>
            <InputLabel>Eixo</InputLabel>
            <Select name="eixo" value={filtros.eixo} label="Eixo" onChange={handleChange}>
              <MenuItem value=""><em>Todos os Eixos</em></MenuItem>
          ...
          <FormControl fullWidth size="small" sx={{ flex: 1, minWidth: '180px' }}>
            ...
            <Select name="turma" value={filtros.turma} label="Turma" onChange={handleChange}>
          ...
          <FormControl fullWidth size="small" sx={{ flex: 1, minWidth: '180px' }}>
            ...
            <Select name="ano" value={filtros.ano} label="Ano" onChange={handleChange}>
          ...
          <FormControl fullWidth size="small" sx={{ flex: 1, minWidth: '180px' }}>
            ...
            <Select name="tipo" value={filtros.tipo} label="Tipo de Disciplina" onChange={handleChange}>
